...
namespace FLICButton
{
    ...
    interface FLICButtonDelegate
    {
        ...
        void Button(FLICButton button, [NullAllowed] NSError error);
        ...
        void Button(FLICButton button, float voltage);
        ...
        void Button(FLICButton button, string nickname);
    }
